...
def main():
    ...
    ax[1, 0].set_title("Tokens (Original)", fontsize=VIS_FONTSIZE)
    ax[1, 0].axis("off")
    ax[0, 1].imshow(image_ndarray_shifted)
    ax[0, 1].set_title("Shifted Image", fontsize=VIS_FONTSIZE)
    ax[0, 1].axis("off")
    ax[1, 1].imshow(tokens_shifted, cmap=VIS_CMAP)
    ax[1, 1].set_title("Tokens (Shifted)", fontsize=VIS_FONTSIZE)
    ax[1, 1].axis("off")
    ax[0, 2].imshow(image_ndarray_hshifted)
    ax[0, 2].set_title("Half-Shifted Image", fontsize=VIS_FONTSIZE)
    ax[0, 2].axis("off")
    ax[1, 2].imshow(tokens_hshifted, cmap=VIS_CMAP)
    ax[1, 2].set_title("Tokens (Half-Shifted)", fontsize=VIS_FONTSIZE)
    ax[1, 2].axis("off")
