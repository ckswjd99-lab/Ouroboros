...
from ipconv.models import MaskedRCNN_ViT_L_FPN_Contexted
...
@torch.no_grad()
def validate_DAVIS(model, sequence_name, gop, data_root="/data/DAVIS", output_dir="./output/contexted_inference_vitdet_l"):
    # constants
...
def main():
    ...
    output_dir = "./output/contexted_inference_vitdet_l"

    model = MaskedRCNN_ViT_L_FPN_Contexted("cuda")
    model.load_weight("./ipconv/models/model_final_6146ed.pkl")
    model.eval()
