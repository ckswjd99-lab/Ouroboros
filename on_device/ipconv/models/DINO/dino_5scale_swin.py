...
class DINO_5Scale_Swin_Contexted(nn.Module):
    def __init__(self, device='cuda'):
        super(DINO_5Scale_Swin_Contexted, self).__init__()
        self.device = device
        self.model, self.criterion, self.postprocessors = build_dino_5scale_swin(device=device)
        self.model.eval()
